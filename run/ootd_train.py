...
def get_opt():
    ...
    parser.add_argument('--dataset_dir', type=str, default=r'../zalando-hd-resized')
...
def main():
    ...
    # Add local ootd folder to the Python module search path
    ...
    scheduler_path = "../checkpoints/ootd/scheduler/scheduler_config.json"
...
if __name__ == '__main__':
    ...
    # from accelerate.commands.launch import LaunchConfig, prepare_locals

    # You can call your training logic here
    # Just move the code that starts training into a `main()` function first.
